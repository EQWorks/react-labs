...
storiesOf('TextField', module)
  ...
  .add('Helper Text', () => <TextField autoFocus helperText='Helper text goes here...' />)
  .add('Error', () => <TextField error autoFocus label='Error' helperText='Fix it now.' />)
  .add('Multiline', () => (
    <TextField
      autoFocus
      label='Multiline'
  ...
  .add('Adornment as Button', () => {
    const [values, setValues] = useState({ show: false, password: 'hello there' })
    return (<TextField
      id='password'
      label='Password'
